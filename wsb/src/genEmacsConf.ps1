...
$cmdContent = @"
Powershell Start-Process Powershell -WorkingDirectory $guestHome -WindowStyle Normal -Argumentlist '-NoProfile -NoLogo -NoExit -ExecutionPolicy Bypass -File $guestPoshFile'
"@
