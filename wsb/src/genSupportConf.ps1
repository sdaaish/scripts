...
$cmdContent = @"
Powershell Start-Process Powershell -WorkingDirectory $guestHome -WindowStyle Normal -Argumentlist '-NoProfile -NoLogo -ExecutionPolicy Bypass -File $guestPoshFile'
"@
